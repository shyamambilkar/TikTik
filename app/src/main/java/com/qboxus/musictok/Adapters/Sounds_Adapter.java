...
import com.qboxus.musictok.Models.Sound_catagory_Get_Set;
...
public class Sounds_Adapter extends RecyclerView.Adapter<Sounds_Adapter.CustomViewHolder > implements Filterable {
    ...
    public void onBindViewHolder(final Sounds_Adapter.CustomViewHolder holder, final int i) {
        ...
        Sound_catagory_Get_Set item=datalist_filter.get(i);
        holder.title.setText(item.catagory);

        holder.bind(i,new Sounds_GetSet(),listener);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int pos , final Sounds_GetSet item, final Sounds_Adapter.OnItemClickListener listener) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Sound_catagory_Get_Set> filteredList = new ArrayList<>();
                    for (Sound_catagory_Get_Set row : datalist) {

                        ArrayList<Sounds_GetSet> soundList=new ArrayList<>();
                        for (Sounds_GetSet sounds_getSet:row.sound_list){
                            if (sounds_getSet.sound_name.toLowerCase().contains(charString.toLowerCase())) {
                                soundList.add(sounds_getSet);
                            }
                        }
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                datalist_filter = (ArrayList<Sound_catagory_Get_Set>) filterResults.values;
